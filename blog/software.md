...
![屏幕截图 2025-09-11 152127](java软件开发工具.assets/屏幕截图 2025-09-11 152127.png)
...
![屏幕截图 2025-09-11 143441](java软件开发工具.assets/屏幕截图 2025-09-11 143441.png)

2.选择下一步

![屏幕截图 2025-09-11 132112](java软件开发工具.assets/屏幕截图 2025-09-11 132112.png)

3.默认安装在C盘，这里我安装在D盘，选择下一步

![屏幕截图 2025-09-11 132345](java软件开发工具.assets/屏幕截图 2025-09-11 132345.png)

4.把配置项都勾选上，选择下一步

![屏幕截图 2025-09-11 132522](java软件开发工具.assets/屏幕截图 2025-09-11 132522.png)
...
![屏幕截图 2025-09-11 132617](java软件开发工具.assets/屏幕截图 2025-09-11 132617.png)

7.此时桌面上会有这个图标

![屏幕截图 2025-09-11 132817](java软件开发工具.assets/屏幕截图 2025-09-11 132817.png)

二。

1.注册， 进入文件夹：“\\JetBrains  2024 最新全家桶激活\\方式3：永久激活补丁+脚本（适合最新版本，可显示到2025年）”：

![屏幕截图 2025-09-11 133328](java软件开发工具.assets/屏幕截图 2025-09-11 133328.png)

2.复制"jetbra"整个文件夹到你安装的idea文件夹，粘贴到目标目录的过程会出现安全提示，选择"继续"

![屏幕截图 2025-09-11 133350](java软件开发工具.assets/屏幕截图 2025-09-11 133350.png)

3.最后得到的路径为：D:\idea

4.按【Win + R】快捷键，调起“运行”窗口，输入“cmd”，然后按【Shift + Ctrl + Enter】组合键，以管理员身份运行命令行窗口：

![屏幕截图 2025-09-11 140011](java软件开发工具.assets/屏幕截图 2025-09-11 140011.png)

通过管理员身份运行的命令行窗口，会有提权确认，选择“是”，此时打开的命令行窗口左上角会有“管理员”字样，这个是确认是否已经正确以管理员身份运行的重要提示，如果没有，则说明没有提权成功。

![屏幕截图 2025-09-11 140132](java软件开发工具.assets/屏幕截图 2025-09-11 140132.png)

5.在命令行窗口，先输入d:，然后cd进入"D:\idea\jetbra\scripts"，然后执行“install-all-users.vbs”：

6.运行完会有确认配置提示，选择“确定”，这一步的目的是写入环境变量：

![屏幕截图 2025-09-11 140656](java软件开发工具.assets/屏幕截图 2025-09-11 140656.png)
